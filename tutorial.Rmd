...
```{r load-refs, message=FALSE, warning=FALSE, error=FALSE}
...
```{r combine-data, message=FALSE, warning=FALSE, error=FALSE}
...
```{r combine-samples, message=FALSE, warning=FALSE, error=FALSE}
...
```{r look-at-ischemic, message=FALSE, warning=FALSE, error=FALSE}
...
```{r set-ischemic-batch, message=FALSE, warning=FALSE, error=FALSE}
...
```{r set-tissue-batch, message=FALSE, warning=FALSE, error=FALSE}
...
```{r batch-correction, message=FALSE, warning=FALSE, error=FALSE}
...
```{r herv-l1-setup, message=FALSE, warning=FALSE, error=FALSE}
...
```{r filter-original-data, message=FALSE, warning=FALSE, error=FALSE}
...
```{r filter-batch, message=FALSE, warning=FALSE, error=FALSE}
cutoff.count <- 5
...
```{r pca-function, message=FALSE, warning=FALSE, error=FALSE}
...
```{r deseq-original, message=FALSE, warning=FALSE, error=FALSE}
...
```{r pca-original, message=FALSE, warning=FALSE, error=FALSE}
...
```{r plot-original-pca, message=FALSE, warning=FALSE, error=FALSE}
...
```{r deseq-corrected, message=FALSE, warning=FALSE, error=FALSE}
...
```{r pca-corrected, message=FALSE, warning=FALSE, error=FALSE}
...
```{r plot-corrected-pca, message=FALSE, warning=FALSE, error=FALSE}
...
```{r deseq-herv, message=FALSE, warning=FALSE, error=FALSE}
...
```{r plot-herv-pca, message=FALSE, warning=FALSE, error=FALSE}
...
```{r read-count-function, message=FALSE, warning=FALSE, error=FALSE}
...
```{r calculate-te-hervs, message=FALSE, warning=FALSE, error=FALSE}
...
```{r plot-percent, message=FALSE, warning=FALSE, error=FALSE}
...
```{r set-thresholds, message=FALSE, warning=FALSE, error=FALSE}
...
```{r de-genes-hervs, message=FALSE, warning=FALSE, error=FALSE}
...
```{r de-hervs, message=FALSE, warning=FALSE, error=FALSE}
...
```{r top-hervs, message=FALSE, warning=FALSE, error=FALSE}
...
```{r heatmap-colors, message=FALSE, warning=FALSE, error=FALSE}
...
```{r volcano, message=FALSE, warning=FALSE, error=FALSE}
...
```{r plot-counts-function, message=FALSE, warning=FALSE, error=FALSE}
...
```{r plot-ind-hervs, message=FALSE, warning=FALSE, error=FALSE}
...
```{r family-level, message=FALSE, warning=FALSE, error=FALSE}
...
```{r plot-family, message=FALSE, warning=FALSE, error=FALSE}
...
```{r import-hallmark, message=FALSE, warning=FALSE, error=FALSE}
...
```{r fgsea-function, message=FALSE, warning=FALSE, error=FALSE}
...
```{r run-fgsea, message=FALSE, warning=FALSE, error=FALSE}
...
```{r classic-plot, message=FALSE, warning=FALSE, error=FALSE}
